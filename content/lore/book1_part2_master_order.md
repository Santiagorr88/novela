# Libro I, Parte 2 — orden maestro de lectura (decidido 2026-08-14)

**Decisión del usuario (2026-08-14)**: intercalar la espina original de la Parte 2, el arco de Lament (sustituye a B1C14) y las 5 tramas nuevas (Necrópolis N1 sustituye a B1C16) en el siguiente orden, eligiendo la opción recomendada que respeta las dos dependencias narrativas duras: Foras vs. Vepar necesita que el arco de Lament ya haya ocurrido (F1 continúa la semilla de L6), y el cierre de Turein (T4) conecta con el hilo del Codex Mortalis ya activo desde Lament.

Este documento es el tracker vivo de la Parte 2, análogo a `book1_part1_expanded_beats.md` para la Parte 1. Cada capítulo se marca con su estado al escribirse.

## Orden aprobado (35 capítulos-unidad)
...
| 16 | N1 — "Lo que el coro no canta" (expande B1C16, POV Kurel/Daith) | `book1_new_subplots_beats.md` (Trama 3) | `B1N01_EN.md` | ✅ Escrito y APPROVED (2.238 palabras tras pulido de compresión, 2026-08-15, re-APPROVED en 2 rondas) — sustituye a B1C16 |
| 17 | N2 — "La discrepancia" | `book1_new_subplots_beats.md` (Trama 3) | `B1N02_EN.md` | ✅ Escrito y APPROVED (2.128 palabras tras pulido de compresión, 2026-08-15, re-APPROVED en 4 rondas) |
| 18 | N3 — "Lo que se queda sin nombre" (cierre) | `book1_new_subplots_beats.md` (Trama 3) | `B1N03_EN.md` | ✅ Escrito y APPROVED (2.281 palabras tras pulido de compresión, 2026-08-15, re-APPROVED en 6 rondas) — **🎉 TRAMA NECRÓPOLIS COMPLETA (N1-N3)** |
| 19 | T1 — "La isla que no aparece en ningún mapa" (POV Cassiel) | `book1_new_subplots_beats.md` (Trama 2) | `B1T01_EN.md` | ✅ Escrito y APPROVED (2.420 palabras tras reescritura de voz, 2026-08-15, re-APPROVED en 2 rondas) |
| 20 | T2 — "El que ya estaba mirando" (POV Selm) | `book1_new_subplots_beats.md` (Trama 2) | `B1T02_EN.md` | ✅ Escrito y APPROVED (2.257 palabras tras reescritura de voz, 2026-08-15, re-APPROVED en 3 rondas) |
| 21 | T3 — "Los acertijos sin respuesta" (POV Cassiel, Selm observando) | `book1_new_subplots_beats.md` (Trama 2) | `B1T03_EN.md` | ✅ Escrito y APPROVED (2.354 palabras tras reescritura de voz, 2026-08-15, re-APPROVED en 5 rondas) — sin diálogo nuevo (excepción deliberada) |
| 22 | T4 — "Lo que ninguno de los dos se queda" (cierre, dual POV) | `book1_new_subplots_beats.md` (Trama 2) | `B1T04_EN.md` | ✅ Escrito y APPROVED (2.406 palabras tras reescritura de voz, 2026-08-15, re-APPROVED en 4 rondas) — **🎉 TRAMA TUREIN COMPLETA (T1-T4)** |
...
- Los archivos `B1L01-06_EN.md` existentes son puramente borradores de calibración pre-beat-planner y deben tratarse como si no existieran a efectos de contenido — reescribir por completo desde los beats detallados en `book1_lament_arc.md`, no editar incrementalmente el texto viejo.
- `B1C28_EN.md` es el único capítulo de toda la Parte 2-3 que ya está terminado; al llegar a él en el orden, solo verificar que no contradice nada de lo escrito mientras tanto (continuidad de nombres, Solmire, Lament) — no reescribir salvo que aparezca una contradicción real.
